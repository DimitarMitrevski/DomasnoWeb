            ...
            _.initials = {
                ...
                dates: {
                    en: {
                        ...
                        monthsShort: ["Јан", "Феб", "Мар", "Апр", "Мај", "Јун", "Јул", "Авг", "Сеп", "Окт", "Нов", "Дек"],
                        noEventForToday: "Нема настани за денеска уживајте...",
                        noEventForThisDay: "Нема настани за овој ден уживајте... :)",
                        previousYearText: "Претходна година",
                        nextYearText: "Следна година",
                        closeSidebarText: "Затвори ја страничната лента",
                        closeEventListText: "Затвори ја лентата со настани"
                    },
                    es: {
